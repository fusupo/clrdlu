...
(defn reset-world []
  ...
  (def block_map {
                  "tt" (atom (block. "tt" ::table 20 0 '(0 0) nil '()))
...
;;(print (put-on @(block_map "w5") @(block_map "b2")))

;;(println (block_map "w5"))
